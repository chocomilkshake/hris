          ...
          -->
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4">
                            <span class="text-muted fw-light">Settings /</span> Add Job Title
                        </h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="job_title">
                                ...
                                <div class="card mb-4">
                                    <h5 class="card-header">Job Title Details</h5>
                                    <!-- Account -->
                                    <div class="card-body">
                                        <!-- Account Form -->
                                        <form id="formAccountSettings" method="POST" action="process/save_job_title.php" enctype="multipart/form-data">
